...
There are 2 graph mining algorithms 
1. Beam Search 
...
|---|---|
|Who talks to whom|Why they talk (trust, liking, fear)|
|Frequency of interaction|Emotional closeness|
|Information flow paths|Intent, motivation, personality|
|Who follows whom on social media|Genuine friendship vs. obligation|
|Communication patterns|Psychological states (anxiety, loyalty)|
...
|Your Claim|Correctness|Clarification|
|---|---|---|
|"Only used in graphical data structure"|✅ Correct|Link mining operates exclusively on graphs (nodes + edges). No graph = no link mining.|
...
## [[Predecting positive and negative Links]]
