...
> You can't deliver software with just a contract and a schedule. You need a well-selected, developed, and motivated team—driven by constant, clear communication.
...
---
## [[Working in Groups]]
A major characteristic of software projects is that they require **teamwork**. Most large projects cannot be completed individually and therefore involve working in groups. However, many individuals in software development may find group work challenging, which can create coordination and communication issues.